...
def render_graph_DefaultRenderGraph():
    ...
    g.create_pass('VAO', 'VAO', {'kVaoRadius': 0.5, 'kVaoExponent': 2.0, 'useAdaptiveSampling' : True, 'kSampleCount': 16, 'resolutionDivisor': 4, 'enableGuardBand': True, 'useDitherTexture': False, 'SVAOInputMode': True, 'useRayInterval': True, 'usePrepass': True, 'prePassSamplingMode': 'Careful'})
    ...
    g.create_pass('SVAO', 'SVAO', {'kVaoRadius': 0.5, 'kVaoExponent': 2.0, 'kSampleCount': 8, 'resolutionDivisor': 4, 'enableGuardBand': True, 'useDitherTexture': False, 'useCameraJitter': True})
    ...
    g.create_pass('VAOPrepass', 'VAOPrepass', {'kVaoRadius': 0.6, 'kVaoExponent': 2.0, 'kSampleCount': 8, 'resolutionDivisor': 4, 'enableGuardBand': True, 'useDitherTexture': False, 'aoThreshold': 0.85})
